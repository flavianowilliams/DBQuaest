...
def question(qpoint, opt):
    ...
    if opt == 'OEIMF001':
        ...
        alt_list = [{'choice': value_1*value_2*value_3*sin(value_4*3.14/180), 'point': qpoint}]
        alt_list.append({'choice': value_1*value_2*value_3*sin(value_4), 'point': 0.75*qpoint})
        alt_list.append({'choice': value_1*value_2*value_3*cos(value_4*3.14/180), 'point': 0.25*qpoint})
        alt_list.append({'choice': value_1*value_2*value_3*value_4, 'point': 0.25*qpoint})
        ...
        for i in range(6):
            ...
            value_3 = random.uniform(p3[0], p3[1])
            value_4 = random.uniform(p4[0], p4[1])
            alt_list.append({'choice': value_1*value_2*value_3*sin(value_4*3.14/180), 'point': 0.0})
